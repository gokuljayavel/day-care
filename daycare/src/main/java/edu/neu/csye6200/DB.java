 ...
 */
public class DB {
        static final String DB_URL = "jdbc:sqlserver://csye6200daycare.database.windows.net:1433;database=Daycare";
        static final String USER = "csyeAdmin@csye6200daycare";
        static final String PASS = "CSYE6200Admin";
